...
export const VOICE_CONFIGS: VoiceConfig[] = [
  { type: 'gentle-female', speaker: 'zh_female_xiaohe_uranus_bigtts', label: '温柔女声', gender: 'female' },
  { type: 'cool-female', speaker: 'zh_female_vv_uranus_bigtts', label: '霸道御姐', gender: 'female' },
  { type: 'cute-female', speaker: 'saturn_zh_female_keainvsheng_tob', label: '可爱软妹', gender: 'female' },
  { type: 'deep-male', speaker: 'zh_male_m191_uranus_bigtts', label: '低沉男声', gender: 'male' },
  { type: 'gentle-male', speaker: 'zh_male_taocheng_uranus_bigtts', label: '温柔男声', gender: 'male' },
];
